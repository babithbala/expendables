...
<body class="skin-black">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="left-side sidebar-offcanvas">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li><a href="basicForm.htm"> <i class="fa fa-globe"></i> <span>Basic
								Elements</span>
					</a></li>
					...
					<li><a
						href="${pageContext.request.contextPath}/calendarBooking.htm">
		...
		<aside class="right-side">
			...
			<section class="content">
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Schedule Application Form
							</header>
							<div class="panel-body">
								...
								<form class="form-horizontal tasi-form" role="form"
									...
									<div class="form-group">
										<label for="membershipInputSex"
											class="col-lg-2 col-sm-2 control-label"> Content<font
											color="red">&nbsp;*</font></label><br>
										<div class="col-lg-8">
											<div class="row">
												<label for="membershipInputDoB"
													class="col-lg-2 col-sm-2 control-label"> Pizza<font
												...
												<label for="membershipInputDoB"
													class="col-lg-2 col-sm-2 control-label"> Coke<font
													color="red">&nbsp;*</font></label>
												<div class="col-lg-4">
													<input type="checkbox" id="membershipInputDoB" name="dob"
														maxlength="8">
									...
									<div class="form-group">
										<label for="membershipInputRole"
											...
											color="red">&nbsp;*</font></label>
										<div class="col-lg-6">
											<input id="pizzaSpinner" name="pizzaSpinner" maxlength="8"><br>
											<input id="cokeSpinner" name="cokeSpinner" maxlength="8">
										</div>
									</div>
									...
									<div class="form-group">
										<label for="membershipInputPassword"
											...
											color="red">&nbsp;*</font></label>
										<div class="col-lg-6">
											<input type="text" name="password" id="pizzaDate"
												placeholder="" class="inputTextToDataPicker">
										</div>
									</div>
									<div class="form-group">
										<label for="membershipInputPassword"
									...
									<div class="form-group">
										<div class="col-lg-offset-2 col-lg-8">
											<button type="submit" class="btn btn-info"
												id="memebershipRegSubmitButton">Submit</button>
											<button type="button" class="btn btn-danger"
												id="memebershipRegCancelButton">Cancel</button>
										</div>
									</div>
								</form>
		...
		<!-- /.right-side -->
		<div class="footer-main">Copyright &copy Babith Balarkan &
			Prashanth Xavier, 2017</div>
	</div>
	<!-- ./wrapper -->
	...
	<script type="text/javascript">
		$(function() {
			...
			populatePrincipalDetails($("#addNewUserFullNameLabelId"),
					$("#addNewUserFirstNameLabelId"));
					...
					.validate(
							{
								...
								rules : {
									...
									streetNo : {
										required : function() {
											return $
													.trim($(
															'#membershipInputStreetName')
															.val()) != ""
													|| $
															.trim($(
																	'#membershipInputCityName')
																	.val()) != ""
													|| $
															.trim($(
																	'#membershipInputCountryCode')
																	.val()) != ""
													|| $
															.trim($(
																	'#membershipInputStateName')
																	.val()) != "";
										}
									},
									streetName : {
								...
								submitHandler : function() {
									...
									$.postJSON(
											"saveOrUpdateNewUserDetails.htm",
											user, function(data) {
