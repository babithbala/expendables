						...
						<section class="panel">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal tasi-form" role="form"
									id="addContentForm">
									<div class="form-group">
										<label for="addEventInputEventName"
											class="col-lg-2 col-sm-2 control-label">
											Content&nbsp;Name<font color="red">&nbsp;*</font>
										</label>
										<div class="col-lg-6">
											...
											<input type="hidden" id="addEventInputAddressId"
												name="addressId">
										</div>
									</div>
									...
									$
											.postJSON(
													...
													function(data) {
														...
														$(
																"#addEventInputEventId")
																.val(eventID);
														$(
																"#addEventInputAddressId")
																.val(addressID);
														$(
