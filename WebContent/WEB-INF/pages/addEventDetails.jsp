                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal tasi-form" role="form" id="addEventForm">
                                ...
                                <div class="form-group">
                                    <label for="addEventInputState"
                                           class="col-lg-2 col-sm-2 control-label">State</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="addEventInputCountry"
                                           class="col-lg-2 col-sm-2 control-label">Country</label>
                                    <div class="col-lg-6">
                                        <select class="form-control m-b-10" id="addEventInputCountryCode"
                                                name="country">
