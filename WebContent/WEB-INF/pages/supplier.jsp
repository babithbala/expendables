                      ...
                      <div class="col-lg-12">
                          <section class="panel">
                              ...
                              <div id="addEventErrorMessage" style="color: red"></div>
                                  <form class="form-horizontal tasi-form" role="form" id="addEventForm">
                                  	 <div class="form-group">
                                          ...
                                          <div class="col-lg-6">
                                          	<input name="eventName" type="text" class="form-control" 
                                          		id="addEventInputEventName" placeholder="Event Name">
                                          	<input type="hidden" id="addEventInputEventId" name="eventId">
                                          	<input type="hidden" id="addEventInputAddressId" name="addressId">
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="addEventInputEventDescription" class="col-lg-2 col-sm-2 control-label">Description</label>
                                          <div class="col-lg-6">
                                          	<input name="eventDescription" type="text" class="form-control" 
                                          		id="addEventInputEventDescription" placeholder="Event Description">
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="addEventInputEventPriority" class="col-lg-2 col-sm-2 control-label">Priority</label>
                                          <div class="col-lg-6">
	                                          <select class="form-control m-b-10" id="addEventInputEventPriority"  name="priority">
                                      ...
                                      <div class="form-group">
                                          <label class="col-sm-2 control-label col-lg-2" for="addEventInputEventDate">
										  Date<font color="red">&nbsp;*</font>&nbsp;&nbsp;Time</label>
                                          <div class="col-lg-8">
                                              <div class="row">
                                                  <div class="col-lg-3">
                                                      <input type="text" id="addEventInputEventDate" name="eventDate" 
	                                          			class="inputTextToDataPicker form-control "  maxlength="8">
                                                  </div>
                                                  
                                                  <div class="col-lg-6">
                                                      <input type="text" name="eventTime" size="12" id="addEventInputEventTime" maxlength="8" 
         									   class="form-control"  value="00:00:00" onFocus="if(this.value=='00:00:00')this.value='';">
                                                  </div>
                                              </div>
                                      ...
                                      <div class="form-group">
                                          <label class="col-sm-2 control-label col-lg-2" for="addEventInputStreetNo">Event&nbsp;Address</label>
                                          <div class="col-lg-8">
                                              <div class="row">
                                                  <div class="col-lg-3">
                                                      <input type="text" class="form-control" id="addEventInputStreetNo"
                                                       placeholder="Street No" name="streetNo">
                                                  </div>
                                                  
                                                  <div class="col-lg-6">
                                                      <input type="text" class="form-control" id="addEventInputStreetName"
                                      ...
                                      <div class="form-group">
                                          <label for="addEventInputCityName" class="col-lg-2 col-sm-2 control-label">City&nbsp;Name</label>
                                          <div class="col-lg-6">
	                                          <input name="cityName" type="text" class="form-control" 
	                                          id="addEventInputCityName" placeholder="City Name">
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="addEventInputState" class="col-lg-2 col-sm-2 control-label">State</label>
                                          <div class="col-lg-6">
	                                          <input name="state" type="text" class="form-control" 
	                                          id="addEventInputStateName" placeholder="State">
                                          </div>
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="addEventInputZipCode" class="col-lg-2 col-sm-2 control-label">Postal&nbsp;/&nbsp;Zip&nbsp;Code</label>
                                          <div class="col-lg-6">
	                                          <input name="zipCode" type="text" class="form-control" 
	                                          id="addEventInputZipCode" placeholder="ZipCode">
                                          </div>
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="addEventInputCountry" class="col-lg-2 col-sm-2 control-label">Country</label>
                                          <div class="col-lg-6">
	                                          <select class="form-control m-b-10" id="addEventInputCountryCode" name="country" >
