                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div id="addSupplierErrorMessage" style="color: red"></div>
                            <form class="form-horizontal tasi-form" role="form" id="addSupplierForm">
                                <div class="form-group">
                                    <label for="supplierName" class="col-lg-2 col-sm-2 control-label">
                                ...
                                <div class="form-group">
                                    <label for="parma" class="col-lg-2 col-sm-2 control-label">Parma</label>
                                    <div class="col-lg-6">
                                        <input name="parma" type="text" class="form-control"
                                               id="parma" placeholder="Parma">
                                    </div>
                                </div>
                                <div class="form-group">
